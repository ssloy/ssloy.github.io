...
plot_values(np.array(anchors), xlim=(-0.01,16.01), title=f"{exponent_bits} exponent bits $\Rightarrow {2**exponent_bits}$ anchors", color='orangered', linewidth=2)
...
#plt.xscale('log')
plot_values(numbers, xlim=(-0.01,16.01), title='``Ideal\'\' logarithmic distribution of 128 numbers', color='green')
