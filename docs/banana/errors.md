...
## Types of errors when solving a physics problem
...
### 1. Choosing *what* equations to solve
...
### 2. Parameter errors: choosing *which* numbers go into the model
...
### 3. Discretization errors: choosing *how* to represent and compute the solution
...
## Solving the problem: optimization under imperfect information
...
Once all approximations are fixed, 
solving a real-world physics problem almost always reduces to an optimization problem.
