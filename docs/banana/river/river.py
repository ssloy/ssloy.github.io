...
plt.text(.74, 0, '$A$', ha='right', va='top', fontsize=24)
plt.text(1.26,0, '$B$', ha='left', va='top', fontsize=24)
plt.text(0, .73, '$C$', ha='right', va='top', fontsize=24)
plt.text(0, 1.24, '$D$', ha='right', va='bottom', fontsize=24)
